...
public class CauHoi {
	...
	public CauHoi(String noiDungCau, String phuongAnA, String phuongAnB, String phuongAnC, String phuongAnD,
			String dapAn) {
	...
	public void xuat() {
		System.out.println("Noi dung cau hoi:" + this.NoiDungCau);
